(function(){
  ...
  section.innerHTML=`
    <div class="lavuq-timeline-wrap">
      ...
      <div class="lavuq-timeline">
        ...
        <div class="lavuq-timeline-row left">
          <article class="lavuq-timeline-card">
            <div class="lavuq-timeline-icon" aria-hidden="true">✎</div>
            <div><h3>1. Kurz bewerben</h3><p>Beantworte ein paar kurze Fragen zu dir, deinem Alltag und deinen Interessen.</p></div>
          </article>
          <div class="lavuq-timeline-dot">1</div><div class="lavuq-timeline-spacer"></div>
        </div>

        <div class="lavuq-timeline-row right">
          <div class="lavuq-timeline-spacer"></div><div class="lavuq-timeline-dot">2</div>
          <article class="lavuq-timeline-card">
            <div class="lavuq-timeline-icon" aria-hidden="true">◎</div>
            <div><h3>2. Gruppe finden</h3><p>Wir stellen eine passende kleine Gruppe aus Würzburg &amp; Umgebung zusammen.</p></div>
          </article>
        </div>
        ...
        <div class="lavuq-timeline-row left">
          <article class="lavuq-timeline-card">
            <div class="lavuq-timeline-icon" aria-hidden="true">▣</div>
            <div><h3>3. Mein Q</h3><p>Nach deiner Zusage findest du Chat, Termine, Ideen und wichtige Infos an einem Ort.</p></div>
          </article>
          <div class="lavuq-timeline-dot">3</div><div class="lavuq-timeline-spacer"></div>
        </div>

        <div class="lavuq-timeline-row right">
          <div class="lavuq-timeline-spacer"></div><div class="lavuq-timeline-dot">4</div>
          <article class="lavuq-timeline-card">
            <div class="lavuq-timeline-icon" aria-hidden="true">⌖</div>
            <div><h3>4. Erstes Treffen</h3><p>Das erste Kennenlernen findet öffentlich, sicher und entspannt statt.</p></div>
          </article>
        </div>
      </div>

      <div class="lavuq-timeline-badges" aria-label="LAVUQ auf einen Blick">
        <span>4 Teilnehmer</span><span>6 Wochen</span><span>mind. 3 Treffen</span><span>Begleitperson erlaubt</span><span>Kein Dating</span>
      </div>
  ...
  style.textContent=`
    ...
    .lavuq-timeline-cta{text-align:center}
    .lavuq-timeline-cta a{display:inline-flex;align-items:center;justify-content:center;gap:13px;min-height:62px;padding:0 34px;border-radius:16px;background:linear-gradient(135deg,#061a30,#0b2b50);color:#fff;text-decoration:none;font-size:1.07rem;font-weight:850;box-shadow:0 14px 34px rgba(6,26,48,.18)}
    .lavuq-timeline-cta a span{color:#e0bb66;font-size:1.25em}
    .lavuq-timeline-footer-text{margin-top:27px;text-align:center;color:#ad7f2d;font-size:.77rem;font-weight:850;letter-spacing:.24em}
    @media(max-width:820px){
      .lavuq-timeline-section{padding:60px 16px}
      .lavuq-timeline-header{text-align:left;margin-bottom:36px}
      .lavuq-timeline-header h2{font-size:clamp(2.15rem,9vw,3.2rem)}
      .lavuq-timeline-subtext{font-size:.98rem;margin:0}
      .lavuq-timeline-line{left:24px;transform:none;top:5px;bottom:5px}
      .lavuq-timeline-row,.lavuq-timeline-row.left,.lavuq-timeline-row.right{display:grid;grid-template-columns:50px minmax(0,1fr);gap:14px;margin-bottom:18px}
      .lavuq-timeline-row .lavuq-timeline-dot{grid-column:1;grid-row:1;width:46px;height:46px;font-size:1rem}
      .lavuq-timeline-row .lavuq-timeline-card{grid-column:2;grid-row:1;padding:19px 17px;border-radius:19px}
      .lavuq-timeline-row .lavuq-timeline-spacer{display:none}
      .lavuq-timeline-card h3{font-size:1.28rem}
      .lavuq-timeline-card p{font-size:.91rem}
      .lavuq-timeline-icon{width:48px;height:48px;flex-basis:48px;font-size:1.35rem}
      .lavuq-timeline-badges{justify-content:flex-start;gap:8px;margin:14px 0 27px}
      .lavuq-timeline-badges span{font-size:.78rem;min-height:36px;padding:7px 12px}
      .lavuq-timeline-cta a{width:100%;min-height:58px}
      .lavuq-timeline-footer-text{font-size:.66rem;line-height:1.6;letter-spacing:.18em}
    }
    @media(max-width:430px){
      .lavuq-timeline-card{gap:12px!important}
      .lavuq-timeline-icon{width:42px;height:42px;flex-basis:42px;font-size:1.2rem}
