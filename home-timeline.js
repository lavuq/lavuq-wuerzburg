(function(){
  ...
  style.textContent=`
    ...
    .lavuq-timeline-badges span{display:inline-flex;align-items:center;justify-content:center;min-height:42px;padding:9px 17px;border:1px solid rgba(184,137,48,.32);border-radius:999px;background:#fff;color:#10243f;font-size:.9rem;font-weight:800;box-shadow:0 6px 18px rgba(7,26,52,.035);text-align:center}
    ...
    @media(max-width:820px){.lavuq-timeline-section{padding:60px 16px}.lavuq-timeline-header{text-align:left;margin-bottom:36px}.lavuq-timeline-header h2{font-size:clamp(2.15rem,9vw,3.2rem)}.lavuq-timeline-subtext{font-size:.98rem;margin:0}.lavuq-timeline-line{left:24px;transform:none;top:5px;bottom:5px}.lavuq-timeline-row,.lavuq-timeline-row.left,.lavuq-timeline-row.right{display:grid;grid-template-columns:50px minmax(0,1fr);gap:14px;margin-bottom:18px}.lavuq-timeline-row .lavuq-timeline-dot{grid-column:1;grid-row:1;width:46px;height:46px;font-size:1rem}.lavuq-timeline-row .lavuq-timeline-card{grid-column:2;grid-row:1;padding:19px 17px;border-radius:19px}.lavuq-timeline-row .lavuq-timeline-spacer{display:none}.lavuq-timeline-card h3{font-size:1.28rem}.lavuq-timeline-card p{font-size:.91rem}.lavuq-timeline-icon{width:48px;height:48px;flex-basis:48px;font-size:1.35rem}.lavuq-timeline-badges{display:grid!important;grid-template-columns:max-content max-content!important;width:max-content!important;max-width:100%!important;justify-content:center!important;justify-items:center!important;gap:8px 10px!important;margin:14px auto 27px!important;text-align:center!important}.lavuq-timeline-badges span{font-size:.78rem;min-height:36px;padding:7px 12px}.lavuq-timeline-badges span:last-child{grid-column:1 / -1!important;justify-self:center!important}.lavuq-timeline-cta a{width:100%;min-height:58px}.lavuq-timeline-footer-text{font-size:.66rem;line-height:1.6;letter-spacing:.18em}}
    @media(max-width:430px){.lavuq-timeline-card{gap:12px!important}.lavuq-timeline-icon{width:42px;height:42px;flex-basis:42px;font-size:1.2rem}.lavuq-timeline-card h3{font-size:1.18rem}.lavuq-timeline-card p{font-size:.86rem}.lavuq-timeline-badges{display:grid!important;grid-template-columns:max-content max-content!important;width:max-content!important;max-width:100%!important;justify-content:center!important;margin-left:auto!important;margin-right:auto!important;gap:8px!important}.lavuq-timeline-badges span{font-size:.76rem;padding:7px 10px}.lavuq-timeline-badges span:last-child{grid-column:1 / -1!important;justify-self:center!important}}
  `;
