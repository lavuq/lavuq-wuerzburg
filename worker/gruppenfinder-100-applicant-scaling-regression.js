...
// Streaming-Auswertung: Millionen Gruppen werden nacheinander bewertet und nicht gesammelt.
...
assert(Object.keys(pairScores).length === 4950, "Bei 100 Bewerbern müssen 4.950 Paar-Scores entstehen.");
assert(evaluatedCount === 3921225, `Bei 100 Bewerbern müssen 3.921.225 4er-Kombinationen entstehen, erhalten: ${evaluatedCount}`);
...
console.log("Gruppenfinder 100-Bewerber-Skalierungstest erfolgreich ✅");
...
console.log("7. Alle 3.921.225 möglichen 4er-Kombinationen verglichen: JA");
